function menuopen() {
    document.querySelector('.menuitemdiv').style.width = '300px';
...
var imgcounter = 0;
var imgarry = ['webdevelopment.JPG', 'appdevelopment.JPG', 'uiux.JPG','hathari.png','student_portal.PNG','calculator.jpeg','anime.jpeg']; // Add more image URLs as needed
